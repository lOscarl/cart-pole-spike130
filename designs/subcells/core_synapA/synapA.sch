...
C {/foss/designs/spike_130/designs/memristors/rram_v1/rramx.sym} 120 -70 0 0 {name=X2
model=rram_cell
spiceprefix=X
gap_i=@ri
}
C {/foss/designs/spike_130/designs/subcells/core_synpCntrl/synpCntrl.sym} 290 -110 0 0 {name=x1}
