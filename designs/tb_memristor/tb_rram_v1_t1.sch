...
B 2 990 -340 1790 60 {flags=graph
y1=2.5
y2=4
ypos1=0
ypos2=2
...
logy=0
color=6
node="GAP; 5 n.x1.n1#ngap -"}
B 2 1790 -340 2590 60 {flags=graph
y1=1
y2=2.5
ypos1=0
ypos2=2
...
C {sky130_fd_pr/corner.sym} 20 -405 0 0 {name=CORNER only_toplevel=true corner=tt}
C {devices/code_shown.sym} -80 -250 0 0 {name=s1 only_toplevel=false value="
*.option savecurrents
.control
 tran 1n 100u uic
 write tb_rram_v1_t1.raw
.endc
.save all" }
...
C {launcher.sym} 640 -370 0 0 {name=h5
descr="load waves" 
tclcommand="xschem raw_read $netlist_dir/tb_rram_v1_t1.raw tran"
}
C {code_shown.sym} -180 -600 0 0 {name=s3 only_toplevel=false value=".subckt rram_cell BE TE gap_i=0.1
N1 BE TE rram_model
...
.endc"}
C {/foss/designs/spike_130/designs/memristors/rram_v1/rramx.sym} 790 -700 1 0 {name=X1
model=rram_cell
spiceprefix=X
gap_i=0.8
}
